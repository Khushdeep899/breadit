...
const Page = () => {
  ...
  const { mutate: createCommunity, isLoading } = useMutation({  //mutation function is any function that handles data fetching logic
    mutationFn: async () => {
      const payload: CreateChannelPayload = {
        name: input,
      }

      const { data } = await axios.post('/api/channel', payload)
